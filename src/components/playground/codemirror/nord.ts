  ...
  return EditorView.theme(
    {
      ...
      ".cm-panels": {
        backgroundColor: dark ? nord0 : nord4,
        color: dark ? nord4 : nord0,
      },
      ".cm-panels.cm-panels-top": {
        borderBottom: `2px solid ${dark ? nord0 : nord4}`,
      },
      ".cm-panels.cm-panels-bottom": {
        borderTop: `2px solid ${dark ? nord0 : nord4}`,
      },
...
export const nordHighlightStyle = (dark: boolean) =>
...
export const nord = (dark: boolean): Extension => [
  nordTheme(dark),
  syntaxHighlighting(nordHighlightStyle(dark)),
];
